...
class user
{
    ...
    public function AddSeed()
    {
        ...
        if (!$found&&$this->validateSeed($seedd)&&$idd!="") {
            $dbh = new db();
    ...
    public function validateSeed($seed){
        if (strlen($seed)==8){
         if (str_contains(strtoupper($seed), "5")||str_contains(strtoupper($seed), "I")||str_contains(strtoupper($seed), "O")||str_contains(strtoupper($seed), "U")){
            return false;
         }else{
             return true;
         }
